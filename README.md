...
- Redis (Cache)
- Swagger (l5-swagger v6) (composer install ile beraber gelecektir fakat endpointler için "php artisan l5-swagger:generate" komutunu girmek gerekir)
- webhook.site
...
**Queue Ayarları**
QUEUE_CONNECTION=database (.env'de  ayarlanmalı)
